              ...
              <div className="row">
                <div className="col-md-6">
                  ...
                  <p><strong>Role:</strong> 
                    <span className={`badge ms-2 ${isMerchant ? 'bg-success' : 'bg-primary'}`}>
                      {user?.role}
                    </span>
                  </p>
                </div>
                <div className="col-md-6">
                  <div className="alert alert-info">
                    <h6>Account Type: {isMerchant ? 'Merchant' : 'Customer'}</h6>
                    {isMerchant && (
                      <p className="mb-0">
                        As a merchant, you can create and manage products for your store.
                      </p>
                    )}
                    {isCustomer && (
                      <p className="mb-0">
                        As a customer, you can browse and purchase products from merchants.
                      </p>
                    )}
                  </div>
                </div>
                  ...
                  <div className="col-md-4 mb-3">
                    <div className="card text-center">
                      <div className="card-body">
                        ...
                        <p className="card-text">Add, edit, or remove your products</p>
                        <Link to="/merchant-dashboard" className="btn btn-primary">
                  ...
                  <div className="col-md-4 mb-3">
                    <div className="card text-center">
                      <div className="card-body">
                        ...
                        <p className="card-text">Check customer orders and manage them</p>
                  ...
                  <div className="col-md-4 mb-3">
                    <div className="card text-center">
                      <div className="card-body">
                        ...
                        <p className="card-text">Explore products from merchants</p>
