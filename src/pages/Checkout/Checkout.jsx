            ...
            <div className="card-body">
              <form>
                ...
                <button
                  ...
                  disabled={!address.fullName || !address.street || !address.city || !address.state || !address.zipCode || !address.phone}
                >
                  Proceed to Payment
                </button>
              </form>
          ...
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
              ...
              <div className="modal-body">
                <p>This is a demo project. Click "Confirm Payment" to simulate a successful payment.</p>
